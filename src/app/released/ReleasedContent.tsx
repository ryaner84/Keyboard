...
// Bargain is a keycap-only surface: it exists to compare the same set's price
// across many vendors and surface the biggest savings. Keyboards are
// single-vendor (no price compare, no savings), so they have their own section
// at /keyboards and never appear here.
...
export default function ReleasedContent() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {/* Row 2: designer + vendor + year + maker + clear */}
